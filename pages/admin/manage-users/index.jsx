          ...
          <div className="flex gap-3">
            <Dropdown>
              <DropdownTrigger className="sm:flex hidden">
                <Button endContent={<Icon name="chevron-down" />} variant="flat">
                  Status
                </Button>
              </DropdownTrigger>
              <DropdownMenu
            ...
            <CustomButton color="green" endContent={<Icon name="ellipsis-vertical" />}>
              Add New
            </CustomButton>
          </div>
        </div>
  ...
  const bottomContent = React.useMemo(() => {
    return (
      <div className="flex items-center justify-between px-2 py-2">
        ...
        <Pagination isCompact showControls showShadow color="success" page={page} total={pages} onChange={setPage} />
        <div className="sm:flex hidden w-[30%] justify-end gap-2">
